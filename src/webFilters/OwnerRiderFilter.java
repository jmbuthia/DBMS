...
@WebFilter("/user/ownerRider/*")
public class OwnerRiderFilter implements Filter {
	@SuppressWarnings("unused")
	private FilterConfig fc;
    public OwnerRiderFilter() {
	...
	public void destroy() {
	 ...
	 public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws IOException, ServletException {
	        ...
	        if(login != null && login.isLoggedIn()){
	        	if(login.getCategory().equals("owner/rider")||login.getCategory().equals("admin")||login.getCategory().equals("teller")){
